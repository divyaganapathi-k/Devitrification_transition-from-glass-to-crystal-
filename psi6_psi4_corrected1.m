...
% nns=0;
   for m=1:1:nn1
     p=ser(m,1);
     o1=TRI_ch(p,7);
     psi6(n,1)=psi6(n,1)+abs((exp(-6*1j*(o1))));%o1 complex
     psi4(n,1)=psi4(n,1)+abs((exp(-4*1j*(o1))));
   end  
   ...
   psi6(n,2)=nn1+psi6(n,2);
    ...
    for m=1:1:nn1
     p=ser(m,1);
     o2=TRI_ch(p,8);
     psi6(n,1)=psi6(n,1)+abs((exp(-6*1j*(o2))));
     psi4(n,1)=psi4(n,1)+abs((exp(-4*1j*(o2))));
    end  
   ...
   for m=1:1:nn1
       p=ser(m,1);
       o3=TRI_ch(p,9);
       psi6(n,1)=psi6(n,1)+abs((exp(-6*1j*(o3))));
       psi4(n,1)=psi4(n,1)+abs((exp(-4*1j*(o3))));
   end     
