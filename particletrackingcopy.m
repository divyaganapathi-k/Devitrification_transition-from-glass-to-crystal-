...
% %     filter_a=butterworth10create(A,9,25);
% %     B=butterworth10apply_uint8(A,filter_a);
%     B=bpass(A,2,7);
% %     image(B);
%     imshow(A);
%     C=feature2D(B,4,9,900,2,2);
%     C(:,6)=i;
%     hold on
